...
def test_HEALPixUNet_optims(
    ...
    # TODO fix graphbreaks in HEALPixUNet model, and enable fullgraph compilation
    model, invar = setup_model()
    assert common.validate_torch_compile(model, (invar,), fullgraph=False, debug=True)
